...
```shell
gem install ./winthrop-client-ruby-1.54.3-dev.10366.gem
```

(for development, run `gem install --dev ./winthrop-client-ruby-1.54.3-dev.10366.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'winthrop-client-ruby', '~> 1.54.3-dev.10366'
...
begin
  ...
  puts "Exception when calling CtbApi->apply_ctb_compensation: #{e}"
end
...
------------ | ------------- | ------------- | -------------
*WinthropClient::CtbApi* | [**apply_ctb_compensation**](docs/CtbApi.md#apply_ctb_compensation) | **POST** /api/v1/ctb_compensation_apply | 
...
*WinthropClient::DefaultApi* | [**batch_guarantee_economics**](docs/DefaultApi.md#batch_guarantee_economics) | **POST** /api/v1/guarantee_economics/batch | 
*WinthropClient::DefaultApi* | [**bulk_create_game_post_searches**](docs/DefaultApi.md#bulk_create_game_post_searches) | **POST** /api/v1/game_post_searches/bulk_create | 
*WinthropClient::DefaultApi* | [**bulk_create_games**](docs/DefaultApi.md#bulk_create_games) | **POST** /api/v1/games/bulk | 
*WinthropClient::DefaultApi* | [**bulk_update_game_post_searches**](docs/DefaultApi.md#bulk_update_game_post_searches) | **POST** /api/v1/game_post_searches/bulk_update | 
...
*WinthropClient::DefaultApi* | [**create_admin_desk_report**](docs/DefaultApi.md#create_admin_desk_report) | **POST** /api/v1/admin/desk_reports | 
*WinthropClient::DefaultApi* | [**create_admin_desk_report_artifact**](docs/DefaultApi.md#create_admin_desk_report_artifact) | **POST** /api/v1/admin/desk_reports/{desk_report_uuid}/artifacts | 
...
*WinthropClient::DefaultApi* | [**create_desk_report_archive**](docs/DefaultApi.md#create_desk_report_archive) | **POST** /api/v1/desk_reports/{uuid}/archive | 
*WinthropClient::DefaultApi* | [**create_desk_report_opened**](docs/DefaultApi.md#create_desk_report_opened) | **POST** /api/v1/desk_reports/{uuid}/opened | 
*WinthropClient::DefaultApi* | [**create_desk_request**](docs/DefaultApi.md#create_desk_request) | **POST** /api/v1/desk_requests | 
...
*WinthropClient::DefaultApi* | [**create_mcp_event**](docs/DefaultApi.md#create_mcp_event) | **POST** /api/v1/mcp_events | 
...
*WinthropClient::DefaultApi* | [**create_requested_item_ri_note**](docs/DefaultApi.md#create_requested_item_ri_note) | **POST** /api/v1/requested_items/{requestedItemId}/ri_note | 
...
*WinthropClient::DefaultApi* | [**delete_admin_desk_report_artifact**](docs/DefaultApi.md#delete_admin_desk_report_artifact) | **DELETE** /api/v1/admin/desk_reports/{desk_report_uuid}/artifacts/{id} | 
...
*WinthropClient::DefaultApi* | [**delete_desk_report_archive**](docs/DefaultApi.md#delete_desk_report_archive) | **DELETE** /api/v1/desk_reports/{uuid}/archive | 
...
*WinthropClient::DefaultApi* | [**get_desk_report**](docs/DefaultApi.md#get_desk_report) | **GET** /api/v1/desk_reports/{uuid} | 
*WinthropClient::DefaultApi* | [**get_desk_report_downloads_zip**](docs/DefaultApi.md#get_desk_report_downloads_zip) | **GET** /api/v1/desk_reports/{uuid}/downloads.zip | 
*WinthropClient::DefaultApi* | [**get_desk_reports**](docs/DefaultApi.md#get_desk_reports) | **GET** /api/v1/desk_reports | 
*WinthropClient::DefaultApi* | [**get_desk_requests**](docs/DefaultApi.md#get_desk_requests) | **GET** /api/v1/desk_requests | 
...
*WinthropClient::DefaultApi* | [**get_eada_financial_searches**](docs/DefaultApi.md#get_eada_financial_searches) | **GET** /api/v1/eada_financial_searches | 
*WinthropClient::DefaultApi* | [**get_eada_metrics**](docs/DefaultApi.md#get_eada_metrics) | **GET** /api/v1/eada_metrics | 
...
*WinthropClient::DefaultApi* | [**get_financial_comparisons**](docs/DefaultApi.md#get_financial_comparisons) | **GET** /api/v1/financial_comparisons | 
...
*WinthropClient::DefaultApi* | [**get_gad_search_season_facets**](docs/DefaultApi.md#get_gad_search_season_facets) | **GET** /api/v1/gad_searches/season_facets | 
...
*WinthropClient::DefaultApi* | [**get_game_post_search_availabilities**](docs/DefaultApi.md#get_game_post_search_availabilities) | **GET** /api/v1/game_post_searches/availabilities | 
...
*WinthropClient::DefaultApi* | [**get_guarantee_benchmarks**](docs/DefaultApi.md#get_guarantee_benchmarks) | **GET** /api/v1/guarantee_benchmarks | 
*WinthropClient::DefaultApi* | [**get_guarantee_economics**](docs/DefaultApi.md#get_guarantee_economics) | **GET** /api/v1/guarantee_economics | 
...
*WinthropClient::DefaultApi* | [**get_position_types**](docs/DefaultApi.md#get_position_types) | **GET** /api/v1/position_types | 
...
*WinthropClient::DefaultApi* | [**get_school_eada_financials**](docs/DefaultApi.md#get_school_eada_financials) | **GET** /api/v1/schools/{schoolId}/eada_financials | 
*WinthropClient::DefaultApi* | [**get_school_financial_selection**](docs/DefaultApi.md#get_school_financial_selection) | **GET** /api/v1/schools/{schoolId}/financial_selection | 
...
*WinthropClient::DefaultApi* | [**get_subscription_acceptance**](docs/DefaultApi.md#get_subscription_acceptance) | **GET** /api/v1/subscription_acceptances/{subscriptionAcceptanceId} | 
...
*WinthropClient::DefaultApi* | [**hide_admin_desk_report**](docs/DefaultApi.md#hide_admin_desk_report) | **POST** /api/v1/admin/desk_reports/{uuid}/hide | 
*WinthropClient::DefaultApi* | [**list_notes**](docs/DefaultApi.md#list_notes) | **GET** /api/v1/notes/list | 
*WinthropClient::DefaultApi* | [**needs_info_admin_desk_request**](docs/DefaultApi.md#needs_info_admin_desk_request) | **PATCH** /api/v1/admin/desk_requests/{uuid}/needs_info | 
*WinthropClient::DefaultApi* | [**publish_admin_desk_report**](docs/DefaultApi.md#publish_admin_desk_report) | **POST** /api/v1/admin/desk_reports/{uuid}/publish | 
...
*WinthropClient::DefaultApi* | [**restore_admin_desk_report**](docs/DefaultApi.md#restore_admin_desk_report) | **POST** /api/v1/admin/desk_reports/{uuid}/restore | 
...
*WinthropClient::DefaultApi* | [**update_admin_desk_report**](docs/DefaultApi.md#update_admin_desk_report) | **PATCH** /api/v1/admin/desk_reports/{uuid} | 
*WinthropClient::DefaultApi* | [**update_admin_desk_request**](docs/DefaultApi.md#update_admin_desk_request) | **PATCH** /api/v1/admin/desk_requests/{uuid} | 
...
*WinthropClient::DefaultApi* | [**update_schedule_intent**](docs/DefaultApi.md#update_schedule_intent) | **PATCH** /api/v1/schedule_intents/{scheduleIntentId} | 
...
*WinthropClient::DefaultApi* | [**update_subscription_acceptance**](docs/DefaultApi.md#update_subscription_acceptance) | **PATCH** /api/v1/subscription_acceptances/{subscriptionAcceptanceId} | 
...
*WinthropClient::DefaultApi* | [**validate_admin_desk_report**](docs/DefaultApi.md#validate_admin_desk_report) | **POST** /api/v1/admin/desk_reports/{uuid}/validate | 
...
*WinthropClient::DefaultApi* | [**view_subscription_acceptance_contract**](docs/DefaultApi.md#view_subscription_acceptance_contract) | **GET** /api/v1/subscription_acceptances/{subscriptionAcceptanceId}/contract | 
...
*WinthropClient::FoiaInboxApi* | [**apply_foia_inbox**](docs/FoiaInboxApi.md#apply_foia_inbox) | **POST** /api/v1/foia_inbox_apply | 
*WinthropClient::FoiaInboxApi* | [**get_foia_inbox_candidates**](docs/FoiaInboxApi.md#get_foia_inbox_candidates) | **GET** /api/v1/foia_inbox_candidates | 
*WinthropClient::GameContractsApi* | [**apply_game_contract**](docs/GameContractsApi.md#apply_game_contract) | **POST** /api/v1/game_contracts/apply | 
*WinthropClient::IntercollegiateApi* | [**create_news_feeds**](docs/IntercollegiateApi.md#create_news_feeds) | **POST** /wi_jobs/news_feeds | 
*WinthropClient::IntercollegiateApi* | [**delete_job_post**](docs/IntercollegiateApi.md#delete_job_post) | **DELETE** /wi_jobs/job_posts/{jobPostId} | 
...
*WinthropClient::ReportingApi* | [**get_foia_follow_up_report**](docs/ReportingApi.md#get_foia_follow_up_report) | **GET** /api/v1/reports/foia_follow_up_report | 
*WinthropClient::ReportingApi* | [**get_foia_request_followup_history**](docs/ReportingApi.md#get_foia_request_followup_history) | **GET** /api/v1/reports/foia_request_followup_history | 
*WinthropClient::ReportingApi* | [**get_foia_requested_item_status_breakdown**](docs/ReportingApi.md#get_foia_requested_item_status_breakdown) | **GET** /api/v1/reports/foia_requested_item_status_breakdown | 
*WinthropClient::ReportingApi* | [**get_foia_requested_item_status_transitions**](docs/ReportingApi.md#get_foia_requested_item_status_transitions) | **GET** /api/v1/reports/foia_requested_item_status_transitions | 
...
*WinthropClient::SalarySitesApi* | [**get_salary_site_associations**](docs/SalarySitesApi.md#get_salary_site_associations) | **GET** /api/v1/salary_site_associations | 
*WinthropClient::ScraperApi* | [**delete_running_job**](docs/ScraperApi.md#delete_running_job) | **DELETE** /ondemand-scrapers/jobs/{job_name} | Delete a running scraper job
*WinthropClient::ScraperApi* | [**list_jobs**](docs/ScraperApi.md#list_jobs) | **GET** /ondemand-scrapers/jobs | List running scraper jobs
...
## Documentation for Models
 ...
 - [WinthropClient::AthleticProfileShowSportCoachStaff](docs/AthleticProfileShowSportCoachStaff.md)
 - [WinthropClient::AthleticProfileShowSportCoachStaffAssistantsInner](docs/AthleticProfileShowSportCoachStaffAssistantsInner.md)
 - [WinthropClient::AthleticProfileShowSportCoachStaffHeadCoach](docs/AthleticProfileShowSportCoachStaffHeadCoach.md)
 - [WinthropClient::AthleticProfileShowSportCoachStaffHeadCoachCareerInner](docs/AthleticProfileShowSportCoachStaffHeadCoachCareerInner.md)
 - [WinthropClient::AthleticProfileShowSportCoachStaffHeadCoachYearOne](docs/AthleticProfileShowSportCoachStaffHeadCoachYearOne.md)
 - [WinthropClient::AthleticProfileShowSportCoachStaffQuadrantPointsInner](docs/AthleticProfileShowSportCoachStaffQuadrantPointsInner.md)
 - [WinthropClient::AthleticProfileShowSportCoachStaffStaffPool](docs/AthleticProfileShowSportCoachStaffStaffPool.md)
 - [WinthropClient::AthleticProfileShowSportCoachStaffSupportStaffInner](docs/AthleticProfileShowSportCoachStaffSupportStaffInner.md)
 - [WinthropClient::AthleticProfileShowSportFinancials](docs/AthleticProfileShowSportFinancials.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostBuild](docs/AthleticProfileShowSportFinancialsCostBuild.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostBuildAssistantPool](docs/AthleticProfileShowSportFinancialsCostBuildAssistantPool.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostBuildGameDayOperating](docs/AthleticProfileShowSportFinancialsCostBuildGameDayOperating.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostBuildGuaranteesNet](docs/AthleticProfileShowSportFinancialsCostBuildGuaranteesNet.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostBuildHeadCoach](docs/AthleticProfileShowSportFinancialsCostBuildHeadCoach.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostBuildHeadCoachUndisclosed](docs/AthleticProfileShowSportFinancialsCostBuildHeadCoachUndisclosed.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostBuildSupportStaffInner](docs/AthleticProfileShowSportFinancialsCostBuildSupportStaffInner.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostPerWin](docs/AthleticProfileShowSportFinancialsCostPerWin.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsCostPerWinCheapest](docs/AthleticProfileShowSportFinancialsCostPerWinCheapest.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsDeptLine](docs/AthleticProfileShowSportFinancialsDeptLine.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsEadaSportLine](docs/AthleticProfileShowSportFinancialsEadaSportLine.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsFrsSplit](docs/AthleticProfileShowSportFinancialsFrsSplit.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsProgramCostPerWin](docs/AthleticProfileShowSportFinancialsProgramCostPerWin.md)
 - [WinthropClient::AthleticProfileShowSportFinancialsProgramCostPerWinCheapest](docs/AthleticProfileShowSportFinancialsProgramCostPerWinCheapest.md)
 ...
 - [WinthropClient::AthleticProfileShowSportGuaranteesAgreementWindow](docs/AthleticProfileShowSportGuaranteesAgreementWindow.md)
 ...
 - [WinthropClient::AthleticProfileShowSportOverviewHeadCoach](docs/AthleticProfileShowSportOverviewHeadCoach.md)
 - [WinthropClient::AthleticProfileShowSportOverviewPayLadderInner](docs/AthleticProfileShowSportOverviewPayLadderInner.md)
 - [WinthropClient::AthleticProfileShowSportOverviewQuadrantPointsInner](docs/AthleticProfileShowSportOverviewQuadrantPointsInner.md)
 - [WinthropClient::AthleticProfileShowSportOverviewSeasonsInner](docs/AthleticProfileShowSportOverviewSeasonsInner.md)
 ...
 - [WinthropClient::BatchGuaranteeEconomicsRequest](docs/BatchGuaranteeEconomicsRequest.md)
 - [WinthropClient::BulkCreateGamePostSearchesRequest](docs/BulkCreateGamePostSearchesRequest.md)
 - [WinthropClient::BulkCreateGamePostSearchesRequestIntentsInner](docs/BulkCreateGamePostSearchesRequestIntentsInner.md)
 - [WinthropClient::BulkCreateGamePostSearchesRequestPostsInner](docs/BulkCreateGamePostSearchesRequestPostsInner.md)
 - [WinthropClient::BulkCreateGames201Response](docs/BulkCreateGames201Response.md)
 - [WinthropClient::BulkCreateGames422Response](docs/BulkCreateGames422Response.md)
 - [WinthropClient::BulkCreateGames422ResponseErrorsValue](docs/BulkCreateGames422ResponseErrorsValue.md)
 - [WinthropClient::BulkCreateGamesRequest](docs/BulkCreateGamesRequest.md)
 - [WinthropClient::BulkCreateGamesRequestGamesInner](docs/BulkCreateGamesRequestGamesInner.md)
 - [WinthropClient::BulkGamePostSearchResult](docs/BulkGamePostSearchResult.md)
 - [WinthropClient::BulkUpdateGamePostSearchesRequest](docs/BulkUpdateGamePostSearchesRequest.md)
 - [WinthropClient::BulkUpdateGamePostSearchesRequestPostsInner](docs/BulkUpdateGamePostSearchesRequestPostsInner.md)
 ...
 - [WinthropClient::CashflowEntry](docs/CashflowEntry.md)
 ...
 - [WinthropClient::CoachCompensationTabQuartiles](docs/CoachCompensationTabQuartiles.md)
 - [WinthropClient::CoachCompensationTabQuartilesRowsInner](docs/CoachCompensationTabQuartilesRowsInner.md)
 ...
 - [WinthropClient::ContractTermOption](docs/ContractTermOption.md)
 ...
 - [WinthropClient::CreateAdminDeskReportArtifact201Response](docs/CreateAdminDeskReportArtifact201Response.md)
 ...
 - [WinthropClient::CreateDeskRequest201Response](docs/CreateDeskRequest201Response.md)
 - [WinthropClient::CreateDeskRequestRequest](docs/CreateDeskRequestRequest.md)
 ...
 - [WinthropClient::CtbCompensationAppliedException](docs/CtbCompensationAppliedException.md)
 - [WinthropClient::CtbCompensationApplyInput](docs/CtbCompensationApplyInput.md)
 - [WinthropClient::CtbCompensationApplyRequest](docs/CtbCompensationApplyRequest.md)
 - [WinthropClient::CtbCompensationApplyResponse](docs/CtbCompensationApplyResponse.md)
 - [WinthropClient::CtbCompensationExpectedRequest](docs/CtbCompensationExpectedRequest.md)
 - [WinthropClient::CtbFoundationEmployeeCompensationApplyInput](docs/CtbFoundationEmployeeCompensationApplyInput.md)
 - [WinthropClient::CtbGraduateAssistantCompensationApplyInput](docs/CtbGraduateAssistantCompensationApplyInput.md)
 - [WinthropClient::CtbNotEmployedCompensationApplyInput](docs/CtbNotEmployedCompensationApplyInput.md)
 - [WinthropClient::CtbThirdPartyContractorCompensationApplyInput](docs/CtbThirdPartyContractorCompensationApplyInput.md)
 - [WinthropClient::CtbVolunteerCompensationApplyInput](docs/CtbVolunteerCompensationApplyInput.md)
 ...
 - [WinthropClient::DepartmentFinancialsEadaLedgerLine](docs/DepartmentFinancialsEadaLedgerLine.md)
 - [WinthropClient::DepartmentFinancialsEadaRole](docs/DepartmentFinancialsEadaRole.md)
 - [WinthropClient::DepartmentFinancialsLedger](docs/DepartmentFinancialsLedger.md)
 - [WinthropClient::DepartmentFinancialsLedgerLine](docs/DepartmentFinancialsLedgerLine.md)
 - [WinthropClient::DepartmentFinancialsNetResult](docs/DepartmentFinancialsNetResult.md)
 - [WinthropClient::DepartmentFinancialsQuadrant](docs/DepartmentFinancialsQuadrant.md)
 - [WinthropClient::DepartmentFinancialsQuadrantPoint](docs/DepartmentFinancialsQuadrantPoint.md)
 ...
 - [WinthropClient::DepartmentGuaranteesAgreement](docs/DepartmentGuaranteesAgreement.md)
 - [WinthropClient::DepartmentGuaranteesAgreementOpponent](docs/DepartmentGuaranteesAgreementOpponent.md)
 - [WinthropClient::DepartmentGuaranteesCommittedSide](docs/DepartmentGuaranteesCommittedSide.md)
 - [WinthropClient::DepartmentGuaranteesFiledLine](docs/DepartmentGuaranteesFiledLine.md)
 - [WinthropClient::DepartmentGuaranteesMarket](docs/DepartmentGuaranteesMarket.md)
 - [WinthropClient::DepartmentGuaranteesMarketSide](docs/DepartmentGuaranteesMarketSide.md)
 - [WinthropClient::DepartmentGuaranteesQuadrant](docs/DepartmentGuaranteesQuadrant.md)
 - [WinthropClient::DepartmentGuaranteesQuadrantPoint](docs/DepartmentGuaranteesQuadrantPoint.md)
 - [WinthropClient::DepartmentGuaranteesSlateCoverage](docs/DepartmentGuaranteesSlateCoverage.md)
 - [WinthropClient::DepartmentGuaranteesSportLedger](docs/DepartmentGuaranteesSportLedger.md)
 - [WinthropClient::DepartmentGuaranteesTrendEntry](docs/DepartmentGuaranteesTrendEntry.md)
 ...
 - [WinthropClient::DepartmentOverviewPrivateAd](docs/DepartmentOverviewPrivateAd.md)
 - [WinthropClient::DepartmentOverviewPrivateAdComp](docs/DepartmentOverviewPrivateAdComp.md)
 - [WinthropClient::DepartmentOverviewPrivateBasis](docs/DepartmentOverviewPrivateBasis.md)
 - [WinthropClient::DepartmentOverviewPrivateCoachingPay](docs/DepartmentOverviewPrivateCoachingPay.md)
 - [WinthropClient::DepartmentOverviewPrivateCoachingPayRow](docs/DepartmentOverviewPrivateCoachingPayRow.md)
 - [WinthropClient::DepartmentOverviewPrivateDisclosure](docs/DepartmentOverviewPrivateDisclosure.md)
 - [WinthropClient::DepartmentOverviewPrivateDisclosureLine](docs/DepartmentOverviewPrivateDisclosureLine.md)
 - [WinthropClient::DepartmentOverviewPrivateFlagship](docs/DepartmentOverviewPrivateFlagship.md)
 - [WinthropClient::DepartmentOverviewPrivateResults](docs/DepartmentOverviewPrivateResults.md)
 - [WinthropClient::DepartmentOverviewPrivateSnapshot](docs/DepartmentOverviewPrivateSnapshot.md)
 - [WinthropClient::DepartmentOverviewPrivateSnapshotLine](docs/DepartmentOverviewPrivateSnapshotLine.md)
 - [WinthropClient::DepartmentOverviewPrivateSpend](docs/DepartmentOverviewPrivateSpend.md)
 ...
 - [WinthropClient::DeskAdminAccount](docs/DeskAdminAccount.md)
 - [WinthropClient::DeskAdminArtifact](docs/DeskAdminArtifact.md)
 - [WinthropClient::DeskAdminCover](docs/DeskAdminCover.md)
 - [WinthropClient::DeskAdminErrorsResponse](docs/DeskAdminErrorsResponse.md)
 - [WinthropClient::DeskAdminErrorsResponseErrorsInner](docs/DeskAdminErrorsResponseErrorsInner.md)
 - [WinthropClient::DeskAdminPublishResponse](docs/DeskAdminPublishResponse.md)
 - [WinthropClient::DeskAdminPublishResponseData](docs/DeskAdminPublishResponseData.md)
 - [WinthropClient::DeskAdminPublishResponseDataReport](docs/DeskAdminPublishResponseDataReport.md)
 - [WinthropClient::DeskAdminQueueResponse](docs/DeskAdminQueueResponse.md)
 - [WinthropClient::DeskAdminQueueResponseMeta](docs/DeskAdminQueueResponseMeta.md)
 - [WinthropClient::DeskAdminQueueRow](docs/DeskAdminQueueRow.md)
 - [WinthropClient::DeskAdminReport](docs/DeskAdminReport.md)
 - [WinthropClient::DeskAdminReportCover](docs/DeskAdminReportCover.md)
 - [WinthropClient::DeskAdminReportCreate](docs/DeskAdminReportCreate.md)
 - [WinthropClient::DeskAdminReportMetadata](docs/DeskAdminReportMetadata.md)
 - [WinthropClient::DeskAdminReportRequest](docs/DeskAdminReportRequest.md)
 - [WinthropClient::DeskAdminReportResponse](docs/DeskAdminReportResponse.md)
 - [WinthropClient::DeskAdminReportUpdate](docs/DeskAdminReportUpdate.md)
 - [WinthropClient::DeskAdminReportsResponse](docs/DeskAdminReportsResponse.md)
 - [WinthropClient::DeskAdminReportsResponseMeta](docs/DeskAdminReportsResponseMeta.md)
 - [WinthropClient::DeskAdminVersion](docs/DeskAdminVersion.md)
 - [WinthropClient::DeskComposition](docs/DeskComposition.md)
 - [WinthropClient::DeskFinding](docs/DeskFinding.md)
 - [WinthropClient::DeskHeadlineStat](docs/DeskHeadlineStat.md)
 - [WinthropClient::DeskHtmlFile](docs/DeskHtmlFile.md)
 - [WinthropClient::DeskReportArchiveResponse](docs/DeskReportArchiveResponse.md)
 - [WinthropClient::DeskReportArchiveResponseData](docs/DeskReportArchiveResponseData.md)
 - [WinthropClient::DeskReportArtifact](docs/DeskReportArtifact.md)
 - [WinthropClient::DeskReportFull](docs/DeskReportFull.md)
 - [WinthropClient::DeskReportFullAllOfSections](docs/DeskReportFullAllOfSections.md)
 - [WinthropClient::DeskReportOpenedResponse](docs/DeskReportOpenedResponse.md)
 - [WinthropClient::DeskReportOpenedResponseData](docs/DeskReportOpenedResponseData.md)
 - [WinthropClient::DeskReportResponse](docs/DeskReportResponse.md)
 - [WinthropClient::DeskReportSummary](docs/DeskReportSummary.md)
 - [WinthropClient::DeskReportSummaryCover](docs/DeskReportSummaryCover.md)
 - [WinthropClient::DeskReportVersion](docs/DeskReportVersion.md)
 - [WinthropClient::DeskReportsResponse](docs/DeskReportsResponse.md)
 - [WinthropClient::DeskReportsResponseMeta](docs/DeskReportsResponseMeta.md)
 - [WinthropClient::DeskRequest](docs/DeskRequest.md)
 - [WinthropClient::DeskRequestContext](docs/DeskRequestContext.md)
 - [WinthropClient::DeskRequestsResponse](docs/DeskRequestsResponse.md)
 ...
 - [WinthropClient::EadaDerivedMetric](docs/EadaDerivedMetric.md)
 - [WinthropClient::EadaFinancialSearchResponse](docs/EadaFinancialSearchResponse.md)
 - [WinthropClient::EadaFinancialSearchResultRow](docs/EadaFinancialSearchResultRow.md)
 - [WinthropClient::EadaInstitutionResult](docs/EadaInstitutionResult.md)
 - [WinthropClient::EadaMetricCatalogEntry](docs/EadaMetricCatalogEntry.md)
 - [WinthropClient::EadaMetricCatalogResponse](docs/EadaMetricCatalogResponse.md)
 - [WinthropClient::EadaNormalizedMetric](docs/EadaNormalizedMetric.md)
 - [WinthropClient::EadaSportResultItem](docs/EadaSportResultItem.md)
 ...
 - [WinthropClient::FinancialComparison](docs/FinancialComparison.md)
 - [WinthropClient::FinancialComparisonRankedRow](docs/FinancialComparisonRankedRow.md)
 - [WinthropClient::FinancialComparisonResponse](docs/FinancialComparisonResponse.md)
 - [WinthropClient::FinancialComparisonSchoolEntry](docs/FinancialComparisonSchoolEntry.md)
 ...
 - [WinthropClient::FinancialSelection](docs/FinancialSelection.md)
 - [WinthropClient::FinancialSelectionMetric](docs/FinancialSelectionMetric.md)
 - [WinthropClient::FinancialSelectionResult](docs/FinancialSelectionResult.md)
 - [WinthropClient::FoiaFollowUpContact](docs/FoiaFollowUpContact.md)
 - [WinthropClient::FoiaFollowUpGmailSearchHints](docs/FoiaFollowUpGmailSearchHints.md)
 - [WinthropClient::FoiaFollowUpNote](docs/FoiaFollowUpNote.md)
 - [WinthropClient::FoiaFollowUpRecentReceivedItem](docs/FoiaFollowUpRecentReceivedItem.md)
 - [WinthropClient::FoiaFollowUpReportMeta](docs/FoiaFollowUpReportMeta.md)
 - [WinthropClient::FoiaFollowUpReportResponse](docs/FoiaFollowUpReportResponse.md)
 - [WinthropClient::FoiaFollowUpReportRow](docs/FoiaFollowUpReportRow.md)
 - [WinthropClient::FoiaFollowUpRequestableData](docs/FoiaFollowUpRequestableData.md)
 - [WinthropClient::FoiaFollowUpRequestedItem](docs/FoiaFollowUpRequestedItem.md)
 - [WinthropClient::FoiaInboxApplyInput](docs/FoiaInboxApplyInput.md)
 - [WinthropClient::FoiaInboxApplyInputExpectedRequest](docs/FoiaInboxApplyInputExpectedRequest.md)
 - [WinthropClient::FoiaInboxApplyRequest](docs/FoiaInboxApplyRequest.md)
 - [WinthropClient::FoiaInboxApplyResponse](docs/FoiaInboxApplyResponse.md)
 - [WinthropClient::FoiaInboxCandidate](docs/FoiaInboxCandidate.md)
 - [WinthropClient::FoiaInboxCandidatesMeta](docs/FoiaInboxCandidatesMeta.md)
 - [WinthropClient::FoiaInboxCandidatesResponse](docs/FoiaInboxCandidatesResponse.md)
 - [WinthropClient::FoiaInboxCompensationException](docs/FoiaInboxCompensationException.md)
 - [WinthropClient::FoiaInboxEffects](docs/FoiaInboxEffects.md)
 - [WinthropClient::FoiaInboxEffectsFoiaRequest](docs/FoiaInboxEffectsFoiaRequest.md)
 - [WinthropClient::FoiaInboxErrorsResponse](docs/FoiaInboxErrorsResponse.md)
 - [WinthropClient::FoiaInboxExpectedCompensation](docs/FoiaInboxExpectedCompensation.md)
 - [WinthropClient::FoiaInboxExpectedPosition](docs/FoiaInboxExpectedPosition.md)
 - [WinthropClient::FoiaInboxExpectedRequestedItem](docs/FoiaInboxExpectedRequestedItem.md)
 - [WinthropClient::FoiaInboxLabel](docs/FoiaInboxLabel.md)
 - [WinthropClient::FoiaInboxNote](docs/FoiaInboxNote.md)
 - [WinthropClient::FoiaInboxRequestableData](docs/FoiaInboxRequestableData.md)
 - [WinthropClient::FoiaInboxRequestedItem](docs/FoiaInboxRequestedItem.md)
 - [WinthropClient::FoiaInboxSchool](docs/FoiaInboxSchool.md)
 ...
 - [WinthropClient::FoiaRequestFollowUpHistoryMeta](docs/FoiaRequestFollowUpHistoryMeta.md)
 - [WinthropClient::FoiaRequestFollowUpHistoryResponse](docs/FoiaRequestFollowUpHistoryResponse.md)
 - [WinthropClient::FoiaRequestFollowUpHistoryRow](docs/FoiaRequestFollowUpHistoryRow.md)
 - [WinthropClient::FoiaRequestedItemStatusBreakdownMeta](docs/FoiaRequestedItemStatusBreakdownMeta.md)
 - [WinthropClient::FoiaRequestedItemStatusBreakdownResponse](docs/FoiaRequestedItemStatusBreakdownResponse.md)
 - [WinthropClient::FoiaRequestedItemStatusBreakdownRow](docs/FoiaRequestedItemStatusBreakdownRow.md)
 ...
 - [WinthropClient::GadCohortSummarySellerFilters](docs/GadCohortSummarySellerFilters.md)
 - [WinthropClient::GadContractDetail](docs/GadContractDetail.md)
 - [WinthropClient::GadSchoolSummary](docs/GadSchoolSummary.md)
 - [WinthropClient::GadSchoolSummarySchool](docs/GadSchoolSummarySchool.md)
 - [WinthropClient::GadSchoolSummarySport](docs/GadSchoolSummarySport.md)
 ...
 - [WinthropClient::GadSummaryError](docs/GadSummaryError.md)
 ...
 - [WinthropClient::GameContractApplyResponse](docs/GameContractApplyResponse.md)
 - [WinthropClient::GameContractApplyResponseActionsValue](docs/GameContractApplyResponseActionsValue.md)
 - [WinthropClient::GameContractApplyResponseActor](docs/GameContractApplyResponseActor.md)
 - [WinthropClient::GameContractApplyResponsePdfProcessing](docs/GameContractApplyResponsePdfProcessing.md)
 - [WinthropClient::GameContractApplyResponseSourceDocument](docs/GameContractApplyResponseSourceDocument.md)
 ...
 - [WinthropClient::GamePostAvailabilityCollection](docs/GamePostAvailabilityCollection.md)
 - [WinthropClient::GamePostAvailabilityCollectionGroupsInner](docs/GamePostAvailabilityCollectionGroupsInner.md)
 - [WinthropClient::GamePostAvailabilityCollectionGroupsInnerPostsInner](docs/GamePostAvailabilityCollectionGroupsInnerPostsInner.md)
 ...
 - [WinthropClient::GamePostSearchResultContactCell](docs/GamePostSearchResultContactCell.md)
 - [WinthropClient::GamePostSearchResultContactEmail](docs/GamePostSearchResultContactEmail.md)
 - [WinthropClient::GamePostSearchResultContactOffice](docs/GamePostSearchResultContactOffice.md)
 ...
 - [WinthropClient::GamePostSearchResultGuarantee](docs/GamePostSearchResultGuarantee.md)
 - [WinthropClient::GamePostSearchResultOverlap](docs/GamePostSearchResultOverlap.md)
 - [WinthropClient::GamePostSearchResultOverlapLineUpsInner](docs/GamePostSearchResultOverlapLineUpsInner.md)
 ...
 - [WinthropClient::GetGadSearchSeasonFacets200Response](docs/GetGadSearchSeasonFacets200Response.md)
 ...
 - [WinthropClient::GuaranteeBenchmarkError](docs/GuaranteeBenchmarkError.md)
 - [WinthropClient::GuaranteeBenchmarkStats](docs/GuaranteeBenchmarkStats.md)
 - [WinthropClient::GuaranteeBenchmarkTable](docs/GuaranteeBenchmarkTable.md)
 - [WinthropClient::GuaranteeBenchmarkTier](docs/GuaranteeBenchmarkTier.md)
 - [WinthropClient::GuaranteeEconomics](docs/GuaranteeEconomics.md)
 - [WinthropClient::GuaranteeEconomicsBatch](docs/GuaranteeEconomicsBatch.md)
 - [WinthropClient::GuaranteeEconomicsBatchPair](docs/GuaranteeEconomicsBatchPair.md)
 - [WinthropClient::GuaranteeEconomicsError](docs/GuaranteeEconomicsError.md)
 - [WinthropClient::GuaranteeEconomicsSide](docs/GuaranteeEconomicsSide.md)
 ...
 - [WinthropClient::HideAdminDeskReportRequest](docs/HideAdminDeskReportRequest.md)
 ...
 - [WinthropClient::InvoiceReportAccount](docs/InvoiceReportAccount.md)
 ...
 - [WinthropClient::McpEvent](docs/McpEvent.md)
 - [WinthropClient::Meta](docs/Meta.md)
 - [WinthropClient::Meta1](docs/Meta1.md)
 - [WinthropClient::NcaaFinancialParticipationSummary](docs/NcaaFinancialParticipationSummary.md)
 - [WinthropClient::NcaaFinancialReportItemGroup](docs/NcaaFinancialReportItemGroup.md)
 - [WinthropClient::NcaaFinancialReportItemValue](docs/NcaaFinancialReportItemValue.md)
 ...
 - [WinthropClient::NcaaFinancialSourceAggregate](docs/NcaaFinancialSourceAggregate.md)
 - [WinthropClient::NcaaFinancialStat](docs/NcaaFinancialStat.md)
 - [WinthropClient::NeedsInfoAdminDeskRequest200Response](docs/NeedsInfoAdminDeskRequest200Response.md)
 - [WinthropClient::NeedsInfoAdminDeskRequest200ResponseData](docs/NeedsInfoAdminDeskRequest200ResponseData.md)
 - [WinthropClient::NeedsInfoAdminDeskRequestRequest](docs/NeedsInfoAdminDeskRequestRequest.md)
 ...
 - [WinthropClient::PositionEntry](docs/PositionEntry.md)
 - [WinthropClient::PositionSportStat](docs/PositionSportStat.md)
 - [WinthropClient::PositionType](docs/PositionType.md)
 - [WinthropClient::PositionTypeCollection](docs/PositionTypeCollection.md)
 ...
 - [WinthropClient::PublishAdminDeskReportRequest](docs/PublishAdminDeskReportRequest.md)
 ...
 - [WinthropClient::SalarySiteAssociation](docs/SalarySiteAssociation.md)
 - [WinthropClient::SalarySiteAssociationsMeta](docs/SalarySiteAssociationsMeta.md)
 - [WinthropClient::SalarySiteAssociationsResponse](docs/SalarySiteAssociationsResponse.md)
 ...
 - [WinthropClient::SchedulingContact](docs/SchedulingContact.md)
 - [WinthropClient::SchedulingContactConference](docs/SchedulingContactConference.md)
 - [WinthropClient::SchedulingContactPerson](docs/SchedulingContactPerson.md)
 - [WinthropClient::SchedulingContactSchool](docs/SchedulingContactSchool.md)
 - [WinthropClient::SchedulingContactsResponse](docs/SchedulingContactsResponse.md)
 ...
 - [WinthropClient::SchoolEadaFinancials](docs/SchoolEadaFinancials.md)
 - [WinthropClient::SchoolEadaFinancialsSports](docs/SchoolEadaFinancialsSports.md)
 ...
 - [WinthropClient::SubscriptionAcceptance](docs/SubscriptionAcceptance.md)
 - [WinthropClient::SubscriptionAcceptanceErrors](docs/SubscriptionAcceptanceErrors.md)
 ...
 - [WinthropClient::TeamScheduleDetailSport](docs/TeamScheduleDetailSport.md)
 ...
 - [WinthropClient::UpdateAdminDeskRequest200Response](docs/UpdateAdminDeskRequest200Response.md)
 - [WinthropClient::UpdateAdminDeskRequest200ResponseData](docs/UpdateAdminDeskRequest200ResponseData.md)
 - [WinthropClient::UpdateAdminDeskRequestRequest](docs/UpdateAdminDeskRequestRequest.md)
 ...
 - [WinthropClient::UpdateScheduleIntentRequest](docs/UpdateScheduleIntentRequest.md)
 - [WinthropClient::UpdateScheduleIntentRequestScheduleIntent](docs/UpdateScheduleIntentRequestScheduleIntent.md)
 ...
 - [WinthropClient::UpdateSubscriptionAcceptanceRequest](docs/UpdateSubscriptionAcceptanceRequest.md)
 - [WinthropClient::UpdateSubscriptionAcceptanceRequestSubscription](docs/UpdateSubscriptionAcceptanceRequestSubscription.md)
 ...
 - [WinthropClient::ValidateAdminDeskReport200Response](docs/ValidateAdminDeskReport200Response.md)
 - [WinthropClient::ValidateAdminDeskReportRequest](docs/ValidateAdminDeskReportRequest.md)
