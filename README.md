...
```shell
gem install ./winthrop-client-ruby-1.53.25.gem
```

(for development, run `gem install --dev ./winthrop-client-ruby-1.53.25.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'winthrop-client-ruby', '~> 1.53.25'
...
*WinthropClient::DefaultApi* | [**get_game_post_search_gap_counts**](docs/DefaultApi.md#get_game_post_search_gap_counts) | **GET** /api/v1/game_post_searches/gap_counts | 
...
## Documentation for Models
 ...
 - [WinthropClient::GamePostGapCountCollection](docs/GamePostGapCountCollection.md)
