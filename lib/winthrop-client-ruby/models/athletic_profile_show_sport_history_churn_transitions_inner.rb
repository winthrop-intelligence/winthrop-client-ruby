...
module WinthropClient
  class AthleticProfileShowSportHistoryChurnTransitionsInner < ApiModelBase
    ...
    attr_accessor :from_coach_last_name

    attr_accessor :to_coach_name

    # Structured last name — may be multi-word (\"Hughley Jr\").
    attr_accessor :to_coach_last_name
    ...
    def self.attribute_map
      {
        ...
        :'from_coach_last_name' => :'from_coach_last_name',
        :'to_coach_name' => :'to_coach_name',
        :'to_coach_last_name' => :'to_coach_last_name',
    ...
    def self.openapi_types
      {
        ...
        :'from_coach_last_name' => :'String',
        :'to_coach_name' => :'String',
        :'to_coach_last_name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'from_coach_last_name')
        self.from_coach_last_name = attributes[:'from_coach_last_name']
      end
      ...
      if attributes.key?(:'to_coach_last_name')
        self.to_coach_last_name = attributes[:'to_coach_last_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          from_coach_last_name == o.from_coach_last_name &&
          to_coach_name == o.to_coach_name &&
          to_coach_last_name == o.to_coach_last_name &&
    ...
    def hash
      [season_year, from_coach_name, from_coach_last_name, to_coach_name, to_coach_last_name, settlement_raw_contract_id].hash
    end
