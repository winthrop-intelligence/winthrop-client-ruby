...
module WinthropClient
  class FrsExportConfig < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WinthropClient::FrsExportConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WinthropClient::FrsExportConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'seeded_from_conference_id')
        ...
        self.seeded_from_conference_id = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @school_ids.nil?
        invalid_properties.push('invalid value for "school_ids", school_ids cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @school_ids.nil?
    ...
    # @param [Object] school_ids Value to be assigned
    def school_ids=(school_ids)
      if school_ids.nil?
        fail ArgumentError, 'school_ids cannot be nil'
      end
    ...
    def hash
      [scope_mode, conference_id, school_group_id, school_ids, sport_ids, financial_year, filename, seeded_from_conference_id].hash
    end
