...
module WinthropClient
  class Position < ApiModelBase
    ...
    attr_accessor :suppress_departing_set_at
    ...
    def self.attribute_map
      {
        ...
        :'suppress_departing_set_at' => :'suppress_departing_set_at',
    ...
    def self.openapi_types
      {
        ...
        :'suppress_departing_set_at' => :'Boolean',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WinthropClient::Position`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'suppress_departing_set_at')
        self.suppress_departing_set_at = attributes[:'suppress_departing_set_at']
      end
    ...
    def valid?
      ...
      creation_reason_validator = EnumAttributeValidator.new('String', ["renewed", "new_hire", "promotion", "extension"])
    ...
    def creation_reason=(creation_reason)
      validator = EnumAttributeValidator.new('String', ["renewed", "new_hire", "promotion", "extension"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          suppress_departing_set_at == o.suppress_departing_set_at &&
