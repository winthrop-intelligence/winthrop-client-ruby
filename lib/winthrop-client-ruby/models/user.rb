...
module WinthropClient
  class User < ApiModelBase
    ...
    def hash
      [id, email, first_name, last_name, created_at, updated_at, state, title, account_id, accountable_id, accountable_type, coach_id, divisions, roles, is_admin, can_see_compensation, can_show_scouting, can_show_game_contract, can_see_coaches, can_see_administrators, can_see_eada_financials, can_show_financials, can_show_deals, can_show_benchmark, can_show_athletic_profile, can_read_conference, can_show_game_post, can_see_school_groups, can_read_account, can_launch_intercollegiate, intercollegiate_url, is_sport_specific, is_d2_only, is_conference_only, permissible_sport_ids, coli_index, subscription_type, schedule_sports, school_name, school_logo_url, school_city, school_state, otp_required, time_zone, scheduling_phone, scheduling_phone_default, scheduling_notifications, game_post_notifications, games_digest, email_domain].hash
    end
