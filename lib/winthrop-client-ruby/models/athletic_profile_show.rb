...
module WinthropClient
  class AthleticProfileShow < ApiModelBase
    ...
    attr_accessor :sport_overview

    attr_accessor :sport_coach_staff
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'sport_overview')
        self.sport_overview = attributes[:'sport_overview']
      end

      if attributes.key?(:'sport_coach_staff')
        self.sport_coach_staff = attributes[:'sport_coach_staff']
      end
