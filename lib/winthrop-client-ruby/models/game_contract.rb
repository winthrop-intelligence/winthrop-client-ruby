...
module WinthropClient
  class GameContract < ApiModelBase
    ...
    attr_accessor :signed_on_formatted
    ...
    def self.attribute_map
      {
        ...
        :'signed_on_formatted' => :'signed_on_formatted',
        :'file_url' => :'file_url',
        :'has_file' => :'has_file'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'signed_on_formatted')
        self.signed_on_formatted = attributes[:'signed_on_formatted']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          signed_on_formatted == o.signed_on_formatted &&
          file_url == o.file_url &&
          has_file == o.has_file
    end
