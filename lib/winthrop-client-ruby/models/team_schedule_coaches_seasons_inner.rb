...
module WinthropClient
  class TeamScheduleCoachesSeasonsInner < ApiModelBase
    ...
    def hash
      [year, wins, losses, ties, rpi, net_rank, ap_rank, record_str, conference_record, postseason, home_record, home_win_percent, sos_ranking, offensive_efficiency, defensive_efficiency].hash
    end
