...
module WinthropClient
  ...
  class ScheduleGridGame < ApiModelBase
    ...
    def hash
      [id, game_date, opponent_id, opponent_name, opponent_short_name, opponent_logo_url, is_home, neutral, guarantee_cents, in_conference, home_school_id, away_school_id, home_school_score, away_school_score, overtime, created_by_school_id, school_entered].hash
    end
