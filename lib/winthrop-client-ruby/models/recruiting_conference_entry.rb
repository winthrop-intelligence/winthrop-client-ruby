...
module WinthropClient
  class RecruitingConferenceEntry < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WinthropClient::RecruitingConferenceEntry` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WinthropClient::RecruitingConferenceEntry`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'overall_record')
        self.overall_record = attributes[:'overall_record']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          overall_record == o.overall_record &&
    ...
    def hash
      [school_name, school_id, class_rank, conference_record, overall_record, postseason].hash
    end
