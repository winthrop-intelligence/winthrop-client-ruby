...
module WinthropClient
  class Coach
    ...
    def hash
      [id, first_name, last_name, email, phone, leader, bio, bio_text, dob, alma_mater_id, alma_mater_year, hometown_city, hometown_state, twitter_handle, linkedin, instagram_handle, current_tenure_years, avatar, years_of_experience, article_link, avatar_scraping_disabled].hash
    end
