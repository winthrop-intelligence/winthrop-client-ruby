...
module WinthropClient
  class SchoolDepartmentOverview < ApiModelBase
    ...
    def hash
      [school, conference, latest_filed_year, selected_year, available_years, results_quadrant, headline_stats, flow_summary, top_revenue_lines, top_expense_lines, dollar_shares, provenance, results_gap, eada_coaching].hash
    end
