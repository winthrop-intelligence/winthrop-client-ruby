...
module WinthropClient
  class CoachSearchResult < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'division_id' => :'Integer',
        :'year' => :'Integer',
        :'newer_season' => :'NewerSeasonContext',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'newer_season')
        self.newer_season = attributes[:'newer_season']
      end
