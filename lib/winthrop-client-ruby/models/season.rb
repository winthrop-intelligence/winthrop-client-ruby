...
module WinthropClient
  class Season < ApiModelBase
    ...
    attr_accessor :away_losses

    attr_accessor :neutral_wins

    attr_accessor :neutral_losses

    attr_accessor :non_division_wins

    attr_accessor :non_division_losses

    attr_accessor :net_rank

    attr_accessor :prev_net_rank

    attr_accessor :ap_rank

    attr_accessor :prev_ap_rank

    attr_accessor :cfp_rank

    attr_accessor :torvik_rank

    attr_accessor :non_conference_sos_ranking

    attr_accessor :conference_sos_ranking

    attr_accessor :ranking_through_date
    ...
    def self.attribute_map
      {
        ...
        :'non_division_wins' => :'non_division_wins',
        :'non_division_losses' => :'non_division_losses',
        :'net_rank' => :'net_rank',
        :'prev_net_rank' => :'prev_net_rank',
        :'ap_rank' => :'ap_rank',
        :'prev_ap_rank' => :'prev_ap_rank',
        :'cfp_rank' => :'cfp_rank',
        :'torvik_rank' => :'torvik_rank',
        :'non_conference_sos_ranking' => :'non_conference_sos_ranking',
        :'conference_sos_ranking' => :'conference_sos_ranking',
        :'ranking_through_date' => :'ranking_through_date',
    ...
    def self.openapi_types
      {
        ...
        :'non_division_wins' => :'Integer',
        :'non_division_losses' => :'Integer',
        :'net_rank' => :'Integer',
        :'prev_net_rank' => :'Integer',
        :'ap_rank' => :'Integer',
        :'prev_ap_rank' => :'Integer',
        :'cfp_rank' => :'Integer',
        :'torvik_rank' => :'Integer',
        :'non_conference_sos_ranking' => :'Integer',
        :'conference_sos_ranking' => :'Integer',
        :'ranking_through_date' => :'Date',
        :'head_coach' => :'Coach',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WinthropClient::Season`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'away_wins')
        self.away_wins = attributes[:'away_wins']
      end

      if attributes.key?(:'away_losses')
        self.away_losses = attributes[:'away_losses']
      end

      if attributes.key?(:'neutral_wins')
        self.neutral_wins = attributes[:'neutral_wins']
      end

      if attributes.key?(:'neutral_losses')
        self.neutral_losses = attributes[:'neutral_losses']
      end

      if attributes.key?(:'non_division_wins')
        self.non_division_wins = attributes[:'non_division_wins']
      end

      if attributes.key?(:'non_division_losses')
        self.non_division_losses = attributes[:'non_division_losses']
      end
      ...
      if attributes.key?(:'prev_net_rank')
        self.prev_net_rank = attributes[:'prev_net_rank']
      end

      if attributes.key?(:'ap_rank')
        self.ap_rank = attributes[:'ap_rank']
      end

      if attributes.key?(:'prev_ap_rank')
        self.prev_ap_rank = attributes[:'prev_ap_rank']
      end

      if attributes.key?(:'cfp_rank')
        self.cfp_rank = attributes[:'cfp_rank']
      end

      if attributes.key?(:'torvik_rank')
        self.torvik_rank = attributes[:'torvik_rank']
      end

      if attributes.key?(:'non_conference_sos_ranking')
        self.non_conference_sos_ranking = attributes[:'non_conference_sos_ranking']
      end

      if attributes.key?(:'conference_sos_ranking')
        self.conference_sos_ranking = attributes[:'conference_sos_ranking']
      end

      if attributes.key?(:'ranking_through_date')
        self.ranking_through_date = attributes[:'ranking_through_date']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          asr == o.asr &&
          away_wins == o.away_wins &&
          away_losses == o.away_losses &&
          neutral_wins == o.neutral_wins &&
          neutral_losses == o.neutral_losses &&
          non_division_wins == o.non_division_wins &&
          non_division_losses == o.non_division_losses &&
          net_rank == o.net_rank &&
          prev_net_rank == o.prev_net_rank &&
          ap_rank == o.ap_rank &&
          prev_ap_rank == o.prev_ap_rank &&
          cfp_rank == o.cfp_rank &&
          torvik_rank == o.torvik_rank &&
          non_conference_sos_ranking == o.non_conference_sos_ranking &&
          conference_sos_ranking == o.conference_sos_ranking &&
          ranking_through_date == o.ranking_through_date &&
