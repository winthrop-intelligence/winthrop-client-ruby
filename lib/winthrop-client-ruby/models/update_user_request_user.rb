...
module WinthropClient
  class UpdateUserRequestUser < ApiModelBase
    ...
    def hash
      [first_name, last_name, email, time_zone, scheduling_phone, scheduling_notifications, game_post_notifications, games_digest, current_password, password, password_confirmation].hash
    end
