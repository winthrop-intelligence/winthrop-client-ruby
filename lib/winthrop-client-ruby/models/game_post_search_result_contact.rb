...
module WinthropClient
  ...
  class GamePostSearchResultContact < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WinthropClient::GamePostSearchResultContact` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WinthropClient::GamePostSearchResultContact`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] office Value to be assigned
    def office=(office)
      if office.nil?
        fail ArgumentError, 'office cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cell Value to be assigned
    def cell=(cell)
      if cell.nil?
        fail ArgumentError, 'cell cannot be nil'
      end
