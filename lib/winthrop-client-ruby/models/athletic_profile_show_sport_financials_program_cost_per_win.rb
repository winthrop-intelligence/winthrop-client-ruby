...
module WinthropClient
  ...
  class AthleticProfileShowSportFinancialsProgramCostPerWin < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'cohort_size' => :'Integer',
        :'cheapest' => :'AthleticProfileShowSportFinancialsProgramCostPerWinCheapest'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WinthropClient::AthleticProfileShowSportFinancialsProgramCostPerWin` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WinthropClient::AthleticProfileShowSportFinancialsProgramCostPerWin`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'margin_cents')
        self.margin_cents = attributes[:'margin_cents']
      end
    ...
    def hash
      [fiscal_year, expense_cents, wins, per_win_cents, margin_cents, cohort_median_per_win_cents, cohort_size, cheapest].hash
    end
