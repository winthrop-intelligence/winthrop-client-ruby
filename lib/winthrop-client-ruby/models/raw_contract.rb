...
module WinthropClient
  class RawContract < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'gs_text')
        self.gs_text = attributes[:'gs_text']
      end
    ...
    def hash
      [id, asset_file_size, asset_content_type, asset_file_name, created_at, updated_at, contract_type_id, uploaded, deal_id, school_id, school_revenue_year, audited_financial_year, text, gs_text, use_flexpaper, game_contracts_count, drive_id, migrated_successfully, migration_failure_reason, unstract_pdf_text, unstract_responses_details, layout_preserved_pdf_text, can_see_admin_view, can_download, school_name, pdf_preview_url, pdf_download_url, has_file, back_to, contract_label, deal_info].hash
    end
