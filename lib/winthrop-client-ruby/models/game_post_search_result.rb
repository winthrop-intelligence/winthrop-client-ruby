...
module WinthropClient
  ...
  class GamePostSearchResult < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'contact' => :'GamePostSearchResultContact',
        :'guarantee' => :'GamePostSearchResultGuarantee',
    ...
    def hash
      [id, publish_group_id, school_id, school_name, sport_id, sport_name, start_date, end_date_display, description, created_at, city, state_name, last_rpi, distance, game_types_display, created_by_name, created_by_scheduling_phone, created_by_scheduling_phone_dial, avg_net_rank, school_logo_url, posts, games, schedule_intents, overlap, contact, guarantee, contacts].hash
    end
