...
module WinthropClient
  class AthleticProfileShowSportOverviewSeasonsInner < ApiModelBase
    ...
    attr_accessor :head_coach_last_name
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'head_coach_last_name')
        self.head_coach_last_name = attributes[:'head_coach_last_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          head_coach_last_name == o.head_coach_last_name &&
    ...
    def hash
      [year, record, conference_record, net_rank, rpi, conference_wins, postseason, head_coach_name, head_coach_last_name, head_coach_interim].hash
    end
