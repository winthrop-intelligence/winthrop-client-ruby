...
module WinthropClient
  class SchoolDepartmentFinancials < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'conference' => :'SchoolDepartmentFinancialsConference',
    ...
    def hash
      [school, conference, latest_filed_year, selected_year, available_years, quadrant, net_result, ranks, revenue, expenses, trend, eada_coaching].hash
    end
