...
module WinthropClient
  class DeskReportFull < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'cover_html')
        self.cover_html = attributes[:'cover_html']
      end
    ...
    def hash
      [cover_html, uuid, title, category, report_type, summary, headline_stats, cover, published_at, updated_at, page_count, artifact_kinds, artifacts, rerun_cadence, push_example, unread, archived, request_context, body_html, versions, sections, version_number, first_open].hash
    end
