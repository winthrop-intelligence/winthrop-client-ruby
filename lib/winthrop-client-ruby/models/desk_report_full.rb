...
module WinthropClient
  class DeskReportFull < ApiModelBase
    ...
    def hash
      [uuid, title, category, report_type, summary, headline_stats, cover, published_at, updated_at, page_count, artifact_kinds, artifacts, rerun_cadence, push_example, unread, request_context, body_html, sections, version_number, first_open].hash
    end
