...
module WinthropClient
  ...
  class GamePostDetail < ApiModelBase
    ...
    def hash
      [id, school_id, school_name, sport_id, sport_name, sport_slug, start_date, end_date, description, status, expires_on, created_at, updated_at, game_types_display, can_manage, created_by, game_types, contacts].hash
    end
