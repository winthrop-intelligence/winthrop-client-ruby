...
module WinthropClient
  class JobPost
    ...
    def hash
      [id, title, link, uid, work_type, description, description_md, salary_summary, annual_salary, pay_period, min_salary, max_salary, school_id, required_years_of_experience, expired, created_at, updated_at, categories].hash
    end
