...
module WinthropClient
  class TeamScheduleDetailGame < ApiModelBase
    ...
    def hash
      [id, game_date, game_date_display, opponent_id, opponent_name, location, city, state_name, opponent_rpi, opponent_avg_rpi, result, score, overtime, in_conference].hash
    end
