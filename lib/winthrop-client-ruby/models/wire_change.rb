...
module WinthropClient
  class WireChange
    ...
    def self.openapi_types
      {
        ...
        :'position_types' => :'Array<WireChangePositionTypesInner>',
        :'sports' => :'Array<WireChangeSportsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WinthropClient::WireChange`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, coach_id, school_id, created_by_id, effective_date, wire_type, position_title, article_link, article_title, article_description, article_site_name, article_publish_time, article_image_url, position_types, sports].hash
    end
