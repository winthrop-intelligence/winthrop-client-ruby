...
module WinthropClient
  class GameContractSeriesResponse < ApiModelBase
    ...
    def hash
      [id, sport_name, home_school_id, home_school_name, away_school_id, away_school_name, game_type, season_year, cancel_fee_cents, has_raw_contract, raw_contract_url, data].hash
    end
