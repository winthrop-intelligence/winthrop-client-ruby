...
module WinthropClient
  ...
  class ScheduleGridAvailableSchoolRow < ApiModelBase
    ...
    def hash
      [id, name, short_name, logo_url, primary_contact_name, primary_contact_email, primary_contact_phone, primary_contact_mobile_phone, subdivision_name, rank, torvik_rank, distance_miles, nearest_post].hash
    end
