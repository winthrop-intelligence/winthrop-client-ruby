...
module WinthropClient
  ...
  class AthleticProfileShowSportFinancials < ApiModelBase
    ...
    attr_accessor :available_fiscal_years
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'available_fiscal_years')
        if (value = attributes[:'available_fiscal_years']).is_a?(Array)
          self.available_fiscal_years = value
        end
      end
