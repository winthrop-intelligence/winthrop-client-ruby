...
module WinthropClient
  class DepartmentSearchResult < ApiModelBase
    ...
    def hash
      [id, name, short_name, city, state_name, conference_name, conference_id, division_name, division_id, subdivision_name, usnwr_ranking, directors_cup_ranking, is_private, nickname, logo_url, department, sports].hash
    end
