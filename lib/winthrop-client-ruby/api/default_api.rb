...
module WinthropClient
  class DefaultApi
    ...
    # @option opts [String] :game_contract_signed_on 
    # @option opts [File] :raw_contract_file 
    # @return [Array<(UpdateGameContract200Response, Integer, Hash)>] UpdateGameContract200Response data, response status code and response headers
    def update_game_contract_with_http_info(game_contract_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UpdateGameContract200Response'
