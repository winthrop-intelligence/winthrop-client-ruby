...
module WinthropClient
  class DefaultApi
    ...
    def create_schedule_intent_with_http_info(create_schedule_intent_request, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'skip_game_post_sync'] = opts[:'skip_game_post_sync'] if !opts[:'skip_game_post_sync'].nil?
