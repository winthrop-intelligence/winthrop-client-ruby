...
module WinthropClient
  class DefaultApi
    ...
    def average_conference_comp(conference_id, season_years, sport_id, position_type_ids, opts = {})
      data, _status_code, _headers = average_conference_comp_with_http_info(conference_id, season_years, sport_id, position_type_ids, opts)
      data
    end
    ...
    def average_conference_comp_with_http_info(conference_id, season_years, sport_id, position_type_ids, opts = {})
      ...
      if @api_client.config.client_side_validation && sport_id.nil?
        fail ArgumentError, "Missing the required parameter 'sport_id' when calling DefaultApi.average_conference_comp"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [AverageCompensation]
    def average_division_comp(division_id, season_years, sport_id, position_type_ids, opts = {})
      data, _status_code, _headers = average_division_comp_with_http_info(division_id, season_years, sport_id, position_type_ids, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AverageCompensation, Integer, Hash)>] AverageCompensation data, response status code and response headers
    def average_division_comp_with_http_info(division_id, season_years, sport_id, position_type_ids, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'sport_id' is set
      if @api_client.config.client_side_validation && sport_id.nil?
        fail ArgumentError, "Missing the required parameter 'sport_id' when calling DefaultApi.average_division_comp"
      end
      # verify the required parameter 'position_type_ids' is set
      if @api_client.config.client_side_validation && position_type_ids.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [AverageCompensation]
    def average_school_comp(school_id, season_years, sport_id, position_type_ids, opts = {})
      data, _status_code, _headers = average_school_comp_with_http_info(school_id, season_years, sport_id, position_type_ids, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AverageCompensation, Integer, Hash)>] AverageCompensation data, response status code and response headers
    def average_school_comp_with_http_info(school_id, season_years, sport_id, position_type_ids, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'sport_id' is set
      if @api_client.config.client_side_validation && sport_id.nil?
        fail ArgumentError, "Missing the required parameter 'sport_id' when calling DefaultApi.average_school_comp"
      end
      # verify the required parameter 'position_type_ids' is set
      if @api_client.config.client_side_validation && position_type_ids.nil?
    ...
    # @param [Hash] opts the optional parameters
    # @return [AverageCompensation]
    def average_subdivision_comp(subdivision_id, season_years, sport_id, position_type_ids, opts = {})
      data, _status_code, _headers = average_subdivision_comp_with_http_info(subdivision_id, season_years, sport_id, position_type_ids, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AverageCompensation, Integer, Hash)>] AverageCompensation data, response status code and response headers
    def average_subdivision_comp_with_http_info(subdivision_id, season_years, sport_id, position_type_ids, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'sport_id' is set
      if @api_client.config.client_side_validation && sport_id.nil?
        fail ArgumentError, "Missing the required parameter 'sport_id' when calling DefaultApi.average_subdivision_comp"
      end
      # verify the required parameter 'position_type_ids' is set
      if @api_client.config.client_side_validation && position_type_ids.nil?
