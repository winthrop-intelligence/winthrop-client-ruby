...
module WinthropClient
  class DefaultApi
    ...
    # @option opts [Integer] :per_page number of results per page. (default to 20)
    # @option opts [Object] :q Ransack query
    # @option opts [String] :sport_name When supplied, each returned school includes a &#x60;rank&#x60; field with its latest sport-appropriate ranking (NET/AP/RPI) for that sport.
