...
module WinthropClient
  class DefaultApi
    ...
    # @param school_ids [Array<Integer>] One or more School ids to compare. Required.
    # @param [Hash] opts the optional parameters
    ...
    # @option opts [String] :family Restrict metrics to one family (e.g. coaching, student_aid, recruiting_expense, operating_expense, revenue_expense, participation).
