...
module WinthropClient
  class DefaultApi
    ...
    # @return [String]
    def summarizer_post_qa_s3(opts = {})
      data, _status_code, _headers = summarizer_post_qa_s3_with_http_info(opts)
      data
    end
    ...
    def summarizer_post_qa_s3_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.summarizer_post_qa_s3 ...'
      end
      # resource path
      local_var_path = '/summarizer/qa_s3'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'summarizer_post_qa_s3_request'])
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.summarizer_post_qa_s3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#summarizer_post_qa_s3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [String]
    def summarizer_post_summarize_s3(opts = {})
      data, _status_code, _headers = summarizer_post_summarize_s3_with_http_info(opts)
      data
    end
    ...
    # @option opts [SummarizerPostSummarizeS3Request] :summarizer_post_summarize_s3_request 
    # @return [Array<(String, Integer, Hash)>] String data, response status code and response headers
    def summarizer_post_summarize_s3_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.summarizer_post_summarize_s3 ...'
      end
      # resource path
      local_var_path = '/summarizer/summarize_s3'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'summarizer_post_summarize_s3_request'])
      ...
      new_options = opts.merge(
        :operation => :"DefaultApi.summarizer_post_summarize_s3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#summarizer_post_summarize_s3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
