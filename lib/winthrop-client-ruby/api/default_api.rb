  ...
  class DefaultApi
    ...
    def get_administrators_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_administrators, must be smaller than or equal to 100.'
      end
    ...
    def get_audited_financial_report_statuses_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_audited_financial_report_statuses, must be smaller than or equal to 100.'
      end
    ...
    def get_categories_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_categories, must be smaller than or equal to 100.'
      end
    ...
    def get_coaches_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_coaches, must be smaller than or equal to 100.'
      end
    ...
    def get_compensations_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_compensations, must be smaller than or equal to 100.'
      end
    ...
    def get_conferences_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_conferences, must be smaller than or equal to 100.'
      end
    ...
    def get_conferenceships_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_conferenceships, must be smaller than or equal to 100.'
      end
    ...
    def get_contacts_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_contacts, must be smaller than or equal to 100.'
      end
    ...
    def get_contracts_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_contracts, must be smaller than or equal to 100.'
      end
    ...
    def get_deal_statuses_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_deal_statuses, must be smaller than or equal to 100.'
      end
    ...
    def get_divisions_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_divisions, must be smaller than or equal to 100.'
      end
    ...
    def get_foia_labels_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_foia_labels, must be smaller than or equal to 100.'
      end
    ...
    def get_foia_requests_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_foia_requests, must be smaller than or equal to 100.'
      end
    ...
    def get_games_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_games, must be smaller than or equal to 100.'
      end
    ...
    def get_income_reports_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_income_reports, must be smaller than or equal to 100.'
      end
    ...
    def get_job_posts_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_job_posts, must be smaller than or equal to 100.'
      end
    ...
    def get_ncaa_financial_report_statuses_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_ncaa_financial_report_statuses, must be smaller than or equal to 100.'
      end
    ...
    def get_positions_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_positions, must be smaller than or equal to 100.'
      end
    ...
    def get_requested_items_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_requested_items, must be smaller than or equal to 100.'
      end
    ...
    def get_schools_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_schools, must be smaller than or equal to 100.'
      end
    ...
    def get_seasons_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_seasons, must be smaller than or equal to 100.'
      end
    ...
    def get_similar_coaches_with_http_info(coach_id, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_similar_coaches, must be smaller than or equal to 100.'
      end
    ...
    def get_sports_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_sports, must be smaller than or equal to 100.'
      end
    ...
    def get_subdivisions_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_subdivisions, must be smaller than or equal to 100.'
      end
    ...
    def get_subscriptions_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_subscriptions, must be smaller than or equal to 100.'
      end
    ...
    def get_users_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_users, must be smaller than or equal to 100.'
      end
    ...
    def get_wire_changes_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling DefaultApi.get_wire_changes, must be smaller than or equal to 100.'
      end
