...
| **rank** | **Integer** | Latest sport-appropriate ranking shown next to the school name (NET for basketball, AP for football, RPI otherwise). Null when the school has no ranked season for the sport. | [optional] |
