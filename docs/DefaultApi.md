...
opts = {
  ...
  per_page: 56, # Integer | number of results per page.
  q: { ... }, # Object | Ransack query
  sport_name: 'sport_name_example' # String | When supplied, each returned school includes a `rank` field with its latest sport-appropriate ranking (NET/AP/RPI) for that sport.
}
...
| **per_page** | **Integer** | number of results per page. | [optional][default to 20] |
| **q** | [**Object**](.md) | Ransack query | [optional] |
| **sport_name** | **String** | When supplied, each returned school includes a &#x60;rank&#x60; field with its latest sport-appropriate ranking (NET/AP/RPI) for that sport. | [optional] |
