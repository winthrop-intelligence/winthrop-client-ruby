...
api_instance = WinthropClient::DefaultApi.new
bulk_create_games_request = WinthropClient::BulkCreateGamesRequest.new({games: [WinthropClient::BulkCreateGamesRequestGamesInner.new({home_school_id: 37, away_school_id: 37, sport_id: 37})]}) # BulkCreateGamesRequest | 

begin
  
  result = api_instance.bulk_create_games(bulk_create_games_request)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->bulk_create_games: #{e}"
end
```

#### Using the bulk_create_games_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BulkCreateGames201Response>, Integer, Hash)> bulk_create_games_with_http_info(bulk_create_games_request)

```ruby
begin
  
  data, status_code, headers = api_instance.bulk_create_games_with_http_info(bulk_create_games_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BulkCreateGames201Response>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->bulk_create_games_with_http_info: #{e}"
end
```
...
api_instance = WinthropClient::DefaultApi.new
bulk_update_game_post_searches_request = WinthropClient::BulkUpdateGamePostSearchesRequest.new({publish_group_id: 'publish_group_id_example', posts: [WinthropClient::BulkUpdateGamePostSearchesRequestPostsInner.new({sport_id: 37, date: Date.today})]}) # BulkUpdateGamePostSearchesRequest | 

begin
  
  result = api_instance.bulk_update_game_post_searches(bulk_update_game_post_searches_request)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->bulk_update_game_post_searches: #{e}"
end
```

#### Using the bulk_update_game_post_searches_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BulkGamePostSearchResult>, Integer, Hash)> bulk_update_game_post_searches_with_http_info(bulk_update_game_post_searches_request)

```ruby
begin
  
  data, status_code, headers = api_instance.bulk_update_game_post_searches_with_http_info(bulk_update_game_post_searches_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BulkGamePostSearchResult>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->bulk_update_game_post_searches_with_http_info: #{e}"
end
```
...
api_instance = WinthropClient::DefaultApi.new
desk_admin_report_create = WinthropClient::DeskAdminReportCreate.new({title: 'title_example', category: 'Financials', report_type: 'intelligence_brief'}) # DeskAdminReportCreate | 
...
begin
  ...
  result = api_instance.create_requested_item_ri_note(requested_item_id, requested_item_note_input)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->create_requested_item_ri_note: #{e}"
end
```

#### Using the create_requested_item_ri_note_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<RequestedItemNoteResponse>, Integer, Hash)> create_requested_item_ri_note_with_http_info(requested_item_id, requested_item_note_input)

```ruby
begin
  
  data, status_code, headers = api_instance.create_requested_item_ri_note_with_http_info(requested_item_id, requested_item_note_input)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <RequestedItemNoteResponse>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->create_requested_item_ri_note_with_http_info: #{e}"
end
```
...
api_instance = WinthropClient::DefaultApi.new
enrich_game_post_searches_request = WinthropClient::EnrichGamePostSearchesRequest.new({pairs: [[37]]}) # EnrichGamePostSearchesRequest | 

begin
  
  result = api_instance.enrich_game_post_searches(enrich_game_post_searches_request)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->enrich_game_post_searches: #{e}"
end
```

#### Using the enrich_game_post_searches_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GamePostEnrichmentCollection>, Integer, Hash)> enrich_game_post_searches_with_http_info(enrich_game_post_searches_request)

```ruby
begin
  
  data, status_code, headers = api_instance.enrich_game_post_searches_with_http_info(enrich_game_post_searches_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GamePostEnrichmentCollection>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->enrich_game_post_searches_with_http_info: #{e}"
end
```
...
> File get_athletic_profile_report(athletic_profile_search_id, sport, opts)
...
sport = 'sport_example' # String | Sport key (non-ADMIN)
opts = {
  year: 56, # Integer | Season year (defaults to the current season)
  scope: 'full', # String | Report scope
  tab: 'overview', # String | Tab key when scope=tab
  appendix: '0' # String | Include the sources appendix ('1' default, '0' to omit)
}

begin
  
  result = api_instance.get_athletic_profile_report(athletic_profile_search_id, sport, opts)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_athletic_profile_report: #{e}"
end
```

#### Using the get_athletic_profile_report_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(File, Integer, Hash)> get_athletic_profile_report_with_http_info(athletic_profile_search_id, sport, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.get_athletic_profile_report_with_http_info(athletic_profile_search_id, sport, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => File
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_athletic_profile_report_with_http_info: #{e}"
end
```
...
| **sport** | **String** | Sport key (non-ADMIN) |  |
| **year** | **Integer** | Season year (defaults to the current season) | [optional] |
| **scope** | **String** | Report scope | [optional][default to &#39;full&#39;] |
| **tab** | **String** | Tab key when scope&#x3D;tab | [optional][default to &#39;overview&#39;] |
| **appendix** | **String** | Include the sources appendix (&#39;1&#39; default, &#39;0&#39; to omit) | [optional][default to &#39;1&#39;] |
...
> <Array<State>> get_filter_options_states
...
begin
  ...
  result = api_instance.get_filter_options_states
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_filter_options_states: #{e}"
end
```

#### Using the get_filter_options_states_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<State>>, Integer, Hash)> get_filter_options_states_with_http_info

```ruby
begin
  
  data, status_code, headers = api_instance.get_filter_options_states_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<State>>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_filter_options_states_with_http_info: #{e}"
end
```
...
api_instance = WinthropClient::DefaultApi.new
school_ids = [37] # Array<Integer> | One or more School ids to compare. Required. More than 40 distinct ids is rejected with a 400.
opts = {
  source: 'eada', # String | 
  grain: 'institution', # String | 
...
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **school_ids** | [**Array&lt;Integer&gt;**](Integer.md) | One or more School ids to compare. Required. More than 40 distinct ids is rejected with a 400. |  |
...
> <Array<AvailableGameContract>> get_games_available_contracts(opts)
...
opts = {
  sport_id: 56, # Integer | 
  home_school_id: 56, # Integer | 
  away_school_id: 56 # Integer | 
}

begin
  
  result = api_instance.get_games_available_contracts(opts)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_games_available_contracts: #{e}"
end
```

#### Using the get_games_available_contracts_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<AvailableGameContract>>, Integer, Hash)> get_games_available_contracts_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.get_games_available_contracts_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<AvailableGameContract>>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_games_available_contracts_with_http_info: #{e}"
end
```
...
api_instance = WinthropClient::DefaultApi.new
requested_item_id = 56 # Integer | ID of requested item whose note should be retrieved

begin
  
  result = api_instance.get_requested_item_ri_note(requested_item_id)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_requested_item_ri_note: #{e}"
end
```

#### Using the get_requested_item_ri_note_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<RequestedItemNoteResponse>, Integer, Hash)> get_requested_item_ri_note_with_http_info(requested_item_id)

```ruby
begin
  
  data, status_code, headers = api_instance.get_requested_item_ri_note_with_http_info(requested_item_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <RequestedItemNoteResponse>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_requested_item_ri_note_with_http_info: #{e}"
end
```
...
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **requested_item_id** | **Integer** | ID of requested item whose note should be retrieved |  |
...
> <ScheduleGridView> get_schedule_grid_completed(sport_name, opts)
...
begin
  ...
  result = api_instance.get_schedule_grid_completed(sport_name, opts)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_schedule_grid_completed: #{e}"
end
```

#### Using the get_schedule_grid_completed_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ScheduleGridView>, Integer, Hash)> get_schedule_grid_completed_with_http_info(sport_name, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.get_schedule_grid_completed_with_http_info(sport_name, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ScheduleGridView>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_schedule_grid_completed_with_http_info: #{e}"
end
```
...
> <SchoolDepartmentFinancials> get_school_department_financials(school_id, opts)
...
school_id = 56 # Integer | ID of the School
opts = {
  year: 56 # Integer | Fiscal year; defaults to the school's latest filed year
}

begin
  
  result = api_instance.get_school_department_financials(school_id, opts)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_school_department_financials: #{e}"
end
```

#### Using the get_school_department_financials_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SchoolDepartmentFinancials>, Integer, Hash)> get_school_department_financials_with_http_info(school_id, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.get_school_department_financials_with_http_info(school_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SchoolDepartmentFinancials>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_school_department_financials_with_http_info: #{e}"
end
```
...
| ---- | ---- | ----------- | ----- |
| **school_id** | **Integer** | ID of the School |  |
| **year** | **Integer** | Fiscal year; defaults to the school&#39;s latest filed year | [optional] |
...
> <SchoolDepartmentOverview> get_school_department_overview(school_id, opts)
...
begin
  ...
  result = api_instance.get_school_department_overview(school_id, opts)
  p result
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_school_department_overview: #{e}"
end
```

#### Using the get_school_department_overview_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SchoolDepartmentOverview>, Integer, Hash)> get_school_department_overview_with_http_info(school_id, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.get_school_department_overview_with_http_info(school_id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SchoolDepartmentOverview>
rescue WinthropClient::ApiError => e
  puts "Error when calling DefaultApi->get_school_department_overview_with_http_info: #{e}"
end
```
...
opts = {
  ...
  family: 'family_example', # String | Restrict metrics to one family (e.g. coaching, student_aid, recruiting_expense, operating_expense, revenue_expense, participation). operating_expense exists at both grains. An unknown family — including one valid only at a grain the request excludes — is a 400, never a silently empty list.
...
| **family** | **String** | Restrict metrics to one family (e.g. coaching, student_aid, recruiting_expense, operating_expense, revenue_expense, participation). operating_expense exists at both grains. An unknown family — including one valid only at a grain the request excludes — is a 400, never a silently empty list. | [optional] |
...
opts = {
  ...
  per_page: 56, # Integer | number of results per page.
  q: { ... }, # Object | Ransack query. A value whose key ends in `_in` is split on commas into a list, so a multi-value predicate travels as one parameter — e.g. `q[primary_conference_division_name_in]=DI,DII`. A blank value yields an empty list, which Ransack drops: the predicate then does not filter at all, rather than matching nothing.
  sport_name: 'BASKETBALL_M' # String | A sport's internal name (e.g. `BASKETBALL_M`, `BASKETBALL_W`, `FOOTBALL`). When supplied, each returned school includes a `rank` field with its latest sport-appropriate ranking (NET/AP/RPI) for that sport. Unknown values are ignored and simply yield no rank.
}
...
| **per_page** | **Integer** | number of results per page. | [optional][default to 20] |
| **q** | [**Object**](.md) | Ransack query. A value whose key ends in &#x60;_in&#x60; is split on commas into a list, so a multi-value predicate travels as one parameter — e.g. &#x60;q[primary_conference_division_name_in]&#x3D;DI,DII&#x60;. A blank value yields an empty list, which Ransack drops: the predicate then does not filter at all, rather than matching nothing. | [optional] |
| **sport_name** | **String** | A sport&#39;s internal name (e.g. &#x60;BASKETBALL_M&#x60;, &#x60;BASKETBALL_W&#x60;, &#x60;FOOTBALL&#x60;). When supplied, each returned school includes a &#x60;rank&#x60; field with its latest sport-appropriate ranking (NET/AP/RPI) for that sport. Unknown values are ignored and simply yield no rank. | [optional] |
