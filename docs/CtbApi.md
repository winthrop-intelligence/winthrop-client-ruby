...
ctb_compensation_apply_request = WinthropClient::CtbCompensationApplyRequest.new({ctb_compensation_apply: WinthropClient::CtbGraduateAssistantCompensationApplyInput.new({review_series_id: 'review_series_id_example', review_revision_sha256: 'review_revision_sha256_example', decision_sha256: 'decision_sha256_example', foia_request_id: 37, school_id: 37, requested_item_id: 37, compensation_id: 37, role: 'graduate_assistant', actions: ['update_requested_item_status'], expected_request: WinthropClient::CtbCompensationExpectedRequest.new({status: 'status_example', updated_at: Time.now, updated_by_school: Date.today, updated_by_wi: Date.today, foia_notes_sha256: 'foia_notes_sha256_example'}), expected_requested_item: WinthropClient::FoiaInboxExpectedRequestedItem.new({status: 'status_example', updated_at: Time.now, ri_note_sha256: 'ri_note_sha256_example'}), expected_compensation: WinthropClient::FoiaInboxExpectedCompensation.new({year: 37, school_id: 37, coach_id: 37, contract_status: 'contract_status_example', comment: 'comment_example', updated_at: Time.now, positions_sha256: 'positions_sha256_example'})})}) # CtbCompensationApplyRequest | 
