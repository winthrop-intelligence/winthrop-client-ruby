...
# Unit tests for WinthropClient::JobStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe WinthropClient::JobStatus do
  # let(:instance) { WinthropClient::JobStatus.new }

  describe 'test an instance of JobStatus' do
    it 'should create an instance of JobStatus' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(WinthropClient::JobStatus)
    end
  end
